...
/// <summary>
/// The First Person Boundaries SDK script provides dummy functions for the play area boundaries.
/// </summary>
[SDK_Description(typeof(SDK_FirstPersonSystem))]
public class SDK_FirstPersonBoundaries : SDK_BaseBoundaries {
    ...
    public override Transform GetPlayArea() {
        if (area == null) {
            ...
            if (firstPersonController) {
                area = firstPersonController.transform;
            }
        }
