...
/// <summary>
/// The First Person Controller SDK script provides functions emulate VR with typical first person input.
/// </summary>
[SDK_Description(typeof(SDK_FirstPersonSystem))]
public class SDK_FirstPersonController : SDK_BaseController {
    protected SDK_FirstPersonControllerSim rightController;
    ...
    public override string GetControllerDefaultColliderPath(ControllerHand hand) {
        return "ControllerColliders/FirstPerson";
    }
        ...
        if (rightController == null) {
            ...
            if (firstPersonController) {
                rightController = (rightController == null
                        ? firstPersonController.GetComponentInChildren<SDK_FirstPersonControllerSim>()
                        : rightController);
            }
        }
    }
