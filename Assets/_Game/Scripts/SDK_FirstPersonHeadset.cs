...
/// <summary>
/// The First Person Headset SDK script  provides dummy functions for the headset.
/// </summary>
[SDK_Description(typeof(SDK_FirstPersonSystem))]
public class SDK_FirstPersonHeadset : SDK_BaseHeadset {
    ...
    public override Transform GetHeadset() {
        if (cameraTransform == null) {
            ...
            if (firstPersonController) {
                var camera = firstPersonController.GetComponentInChildren<Camera>();
                if (camera) {
    ...
    public override string GetHeadsetType() {
        return CleanPropertyString("firstperson");
    }
    ...
    protected virtual void SetHeadsetCaches() {
        ...
        if (cachedHeadsetVelocityEstimator == null && currentHeadset != null) {
            cachedHeadsetVelocityEstimator = (currentHeadset.GetComponent<VRTK_VelocityEstimator>() != null
                    ? currentHeadset.GetComponent<VRTK_VelocityEstimator>()
                    : currentHeadset.gameObject.AddComponent<VRTK_VelocityEstimator>());
        }
    }
}