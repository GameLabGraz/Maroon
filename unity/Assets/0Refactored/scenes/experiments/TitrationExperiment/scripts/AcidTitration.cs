...
{
    private readonly Dictionary<string, int> strongBases = new Dictionary<string, int>() {
        {"NaOH", 0}, 
        {"KOH", 1} };
    private readonly Dictionary<string, int> strongAcids = new Dictionary<string, int>() {
        {"HCl", 0},
        {"HNO3", 1},
        {"H2SO4", 2} };
    private readonly Dictionary<string, double> weakAcids = new Dictionary<string, double>() {
        {"CH3CO2H", 4.75} };
    private readonly Dictionary<string, double> weakBases = new Dictionary<string, double>() {
        {"NH3", 9.25} };
    ...
    public void Calculation(double molTitrant, double mlTitrant, double molAnalyte, double mlAnalyte)
  {
        ...
        double concentration_postequivalence;
        double ph;
        maxRange = mlTitrant;


        double prev_concentration_preequivalence;
