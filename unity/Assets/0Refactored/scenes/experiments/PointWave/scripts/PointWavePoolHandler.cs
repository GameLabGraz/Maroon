...
public class PointWavePoolHandler : MonoBehaviour, IResetWholeObject
{
    public enum Axis
    {
        XAxis,
    ...
    public GameObject CreateCharge(GameObject prefab, Vector3 position, float waveAmplitude, float waveLength, float waveFrequency, float wavePhase,  bool positionInWorldCoord = true)
    {
        ...
        AddParticle(waveSource);
        return obj;
    }


    public void AddParticle(PointWaveSource pointWaveSource)
    {
    ...
    public bool ContainsParticle(PointWaveSource waveSource)
    {
        return _sources.ContainsKey(waveSource.GetSourceKey());
    }

    public void RemoveParticle(PointWaveSource source)
    {
