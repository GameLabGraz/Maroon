...
//     version 1.19.0
//     from Assets/Maroon/GlobalEntities/PlayerManager/MaroonInputActions.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Maroon/GlobalEntities/PlayerManager/MaroonInputActions.inputactions".
/// </summary>
/// <remarks>
...
/// </code>
/// </example>
public partial class @MaroonInputActions: IInputActionCollection2, IDisposable
{
    /// <summary>
    ...
    ~@MaroonInputActions()
    {
        UnityEngine.Debug.Assert(!m_FirstPersonPlayer.enabled, "This will cause a leak and performance issues, MaroonInputActions.FirstPersonPlayer.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_UserInterface.enabled, "This will cause a leak and performance issues, MaroonInputActions.UserInterface.Disable() has not been called.");
    }
    ...
    /// <summary>
    /// Provides access to input actions defined in input action map "FirstPersonPlayer".
    /// </summary>
    public struct FirstPersonPlayerActions
    {
        ...
        /// <summary>
        /// Provides access to the underlying input action "FirstPersonPlayer/Look".
        /// </summary>
        public InputAction @Look => m_Wrapper.m_FirstPersonPlayer_Look;
        /// <summary>
        /// Provides access to the underlying input action "FirstPersonPlayer/Move".
        /// </summary>
        public InputAction @Move => m_Wrapper.m_FirstPersonPlayer_Move;
        /// <summary>
        /// Provides access to the underlying input action "FirstPersonPlayer/Sprint".
        /// </summary>
        public InputAction @Sprint => m_Wrapper.m_FirstPersonPlayer_Sprint;
        /// <summary>
        /// Provides access to the underlying input action "FirstPersonPlayer/Crouch".
        /// </summary>
        public InputAction @Crouch => m_Wrapper.m_FirstPersonPlayer_Crouch;
        /// <summary>
        /// Provides access to the underlying input action "FirstPersonPlayer/Jump".
        /// </summary>
        public InputAction @Jump => m_Wrapper.m_FirstPersonPlayer_Jump;
        /// <summary>
        /// Provides access to the underlying input action "FirstPersonPlayer/Interact".
        /// </summary>
        public InputAction @Interact => m_Wrapper.m_FirstPersonPlayer_Interact;
        /// <summary>
        /// Provides access to the underlying input action "FirstPersonPlayer/Fire".
        /// </summary>
        ...
        /// <summary>
        /// Implicitly converts an <see ref="FirstPersonPlayerActions" /> to an <see ref="InputActionMap" /> instance.
        /// </summary>
        ...
        /// </remarks>
        /// <seealso cref="FirstPersonPlayerActions" />
        ...
        /// <summary>
        /// Unregisters <param cref="instance" /> and unregisters all input action callbacks via <see cref="FirstPersonPlayerActions.UnregisterCallbacks(IFirstPersonPlayerActions)" />.
        /// </summary>
        /// <seealso cref="FirstPersonPlayerActions.UnregisterCallbacks(IFirstPersonPlayerActions)" />
        ...
        /// </remarks>
        /// <seealso cref="FirstPersonPlayerActions.AddCallbacks(IFirstPersonPlayerActions)" />
        /// <seealso cref="FirstPersonPlayerActions.RemoveCallbacks(IFirstPersonPlayerActions)" />
        /// <seealso cref="FirstPersonPlayerActions.UnregisterCallbacks(IFirstPersonPlayerActions)" />
    ...
    /// <summary>
    /// Provides a new <see cref="FirstPersonPlayerActions" /> instance referencing this action map.
    /// </summary>
    ...
    public struct UserInterfaceActions
    {
        ...
        /// <summary>
        /// Provides access to the underlying input action "UserInterface/Click".
        /// </summary>
    ...
    /// <summary>
    /// Interface to implement callback methods for all input action callbacks associated with input actions defined by "FirstPersonPlayer" which allows adding and removing callbacks.
    /// </summary>
    /// <seealso cref="FirstPersonPlayerActions.AddCallbacks(IFirstPersonPlayerActions)" />
    /// <seealso cref="FirstPersonPlayerActions.RemoveCallbacks(IFirstPersonPlayerActions)" />
