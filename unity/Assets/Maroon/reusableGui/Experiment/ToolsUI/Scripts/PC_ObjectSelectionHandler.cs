...
public class PC_ObjectSelectionHandler : MonoBehaviour 
{
    ...
    void Start()
    {
        ...
        coulombValueSlider.onValueChanged.AddListener((newValue) =>
        {
            ...
            selectedObject.GetComponent<Maroon.Physics.Electromagnetism.Charge>().strength = newValue;
    ...
    {
        coulombValueSlider.value = selectedObject.GetComponent<Maroon.Physics.Electromagnetism.Charge>().strength;
    }
