...
[ExecuteInEditMode]
public class WaveEquationWaterPlane : PausableObject, IResetObject
{
    [SerializeField]
    private List<WaveEquationSource> waveSources = new List<WaveEquationSource>();
    ...
    public void RegisterWaveSource(WaveEquationSource waveSource)
    {
        waveSources.Add(waveSource);
    }
    public void UnregisterWaveSource(WaveEquationSource waveSource)
    {
