...
public class GameHandler : MonoBehaviour
{
    ...
    public void UIToggle1(bool checkmark)
    {
        ...
        mercury.GetComponent<Renderer>().enabled = false;
    ...
    public void UIToggle2(bool checkmark)
    {
        ...
        venus.GetComponent<Renderer>().enabled = false;
    ...
    public void UIToggle5(bool checkmark)
    {
        ...
        jupiter.GetComponent<Renderer>().enabled = false;
    ...
    public void UIToggle7(bool checkmark)
    {
        ...
        uranus.GetComponent<Renderer>().enabled = false;
    ...
    public void UIToggle8(bool checkmark)
    {
        ...
        neptune.GetComponent<Renderer>().enabled = false;
