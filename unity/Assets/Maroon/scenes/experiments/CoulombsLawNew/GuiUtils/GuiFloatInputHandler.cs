...
namespace Maroon.Experiments.CoulombsLawNew
{
    public class GuiFloatInputHandler : MonoBehaviour
    {
        ...
        private void Initialize()
        {
            ...
            if (!sliderEnabled && inputFieldEnabled)
            {
                // If only text-field is active, then somethin
                GetComponent<UnityEngine.UI.HorizontalLayoutGroup>().childForceExpandWidth = true;
            }
